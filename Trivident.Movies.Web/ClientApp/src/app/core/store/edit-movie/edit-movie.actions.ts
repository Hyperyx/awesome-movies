...
export namespace EditMovieActions {
  export const EXECUTE = '[EditMovieActions] EXECUTE';
  export const EXECUTE_COMPLETE = '[EditMovieActions] EXECUTE_COMPLETE';
  export const EXECUTE_ERROR = '[EditMovieActions] EXECUTE_ERROR';
  export const EXECUTE_RESET = '[EditMovieActions] EXECUTE_RESET';
